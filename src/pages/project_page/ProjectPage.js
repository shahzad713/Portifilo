                            ...
                            >
                              <div className="projectContent">
                                ...
                                <div className="project--showcaseBtn">
                                  <a
                                    href={
                                      "https://github.com/shahzad713/React-Add-To-Cart"
                                    }
                                    target="_blank"
                                    rel="noreferrer"
                                    className={"iconBtn"}
                              ...
                              <h6>
                                ...
                                >
                                  ...
                                  project, I implemented a user-friendly 'add to
                                  cart' system using TypeScript. It enhances the
                                  shopping experience. Type Safety: TypeScript
                                  ensures type safety, reducing errors and
                                  improving code reliability. Customization: The
                                  system is easily customizable for different
                            ...
                            >
                              <div className="projectContent">
                                ...
                                <div className="project--showcaseBtn">
                                  <a
                                    href={
                                      " https://github.com/shahzad713/React_Api"
                                    }
                                    target="_blank"
                                    rel="noreferrer"
                                    className={"iconBtn"}
                              ...
                              <h6>
                                ...
                                >
                                  Developed a React-based dynamic form for
                                  seamless user addition, utilizing state
                                  management and Axios for server communication.
                                  Created an update page for intuitive data
                                  modification. Implemented a detailed view for
                                  user information and developed a central hub
                                  for user management, showcasing proficiency in
                                  React, state management, and API interactions,
                            ...
                            >
                              <div className="projectPageContent">
                                ...
                                <div className="project--showcaseBtn">
                                  <a
                                    href={
                                      "https://xcrypto-app-react.vercel.app/"
                                    }
                                    target="_blank"
                                    rel="noreferrer"
                                    className={"iconBtn"}
                              ...
                              <h6>
                                ...
                                >
                                  visualization, and API integration. 🚀 The app
                                  offers cryptocurrency price tracking. 💹 It
                                  provides interactive historical data analysis.
                                  🌟 The user-friendly interface enhances the
                                  experience. It's built with React, JavaScript,
                                  CSS, and chart.js
                                </p>
                              </h6>
                              <div
